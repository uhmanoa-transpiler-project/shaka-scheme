...
int main() {
    ...
    expected = {
        Token(Type::PAREN_START, "("),
        Token(Type::IDENTIFIER, "quantifier"),
        Token(Type::IDENTIFIER, "+"),
        Token(Type::IDENTIFIER, "/"),
        Token(Type::IDENTIFIER, "asdf"),
        Token(Type::STRING, "qwer"),
        Token(Type::PAREN_END, ")")
    };
    ...
    do {
        Token t = tokenizer2.get();
        if (t != Token(Type::END_OF_FILE)) {
            input.push_back(t);
        } else {
            break;
        }
    ...
    expected = {
        ...
        Token(Type::CHARACTER, "t"),
    };

    input.clear();
    Tokenizer tokenizer3(ss3);
    do {
        Token t = tokenizer3.get();
        if (t != Token(Type::END_OF_FILE)) {
            input.push_back(t);
        } else {
            break;
