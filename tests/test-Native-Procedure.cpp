...
TEST(Native_procedure, Add_function ){
	...
	//std::function<Args(Args)> adder = number_plus;
	shaka::Native_Procedure b(shaka::stdproc::add_numbers_f, 2);
	auto result = b.call(a);
...
TEST(Native_procedure, Multiply_function ){
	...
	//std::function<Args(Args)> adder = number_plus;
	shaka::Native_Procedure b(shaka::stdproc::mul_numbers_f, 2);
	auto result = b.call(a);
...
TEST(Native_procedure, negative_function ){
	...
	//std::function<Args(Args)> adder = number_plus;
	shaka::Native_Procedure b(shaka::stdproc::neg_numbers_f, 2);
	auto result = b.call(a);
...
TEST(Native_procedure, subtract_function ){
	...
	//std::function<Args(Args)> adder = number_plus;
	shaka::Native_Procedure b(shaka::stdproc::sub_numbers_f, 2);
	auto result = b.call(a);
...
TEST(Native_procedure, reciprocal_function ){
	...
	shaka::Native_Procedure b(shaka::stdproc::reciprocal_numbers_f, 1);
...
TEST(Native_procedure, divide_function ){
	...
	shaka::Number answer(2);
	shaka::Native_Procedure b(shaka::stdproc::div_numbers_f, 2);
	//Currently this returns a float it should return a rational
	//Must fix this
	auto result = b.call(a);
...
TEST(Native_procedure, abs_value_function ){
	...
	shaka::Number answer(2);
	shaka::Native_Procedure b(shaka::stdproc::abs_numbers_f, 1);
	
	shaka::Native_Procedure d(shaka::stdproc::abs_numbers_f, 1);
	//Currently this returns a float it should return a rational
	//Must fix this
	auto result = b.call(a);
...
TEST(Native_procedure, floor_div_function ){
	...
	shaka::Native_Procedure b(shaka::stdproc::floor_div_numbers_f, 2);
...
TEST(Native_procedure, floor_quotient_function ){
	...
	shaka::Number answer(2);
	shaka::Native_Procedure b(shaka::stdproc::floor_quotient_numbers_f, 2);
...
TEST(Native_procedure, floor_remainder_function ){
	...
	shaka::Native_Procedure b(shaka::stdproc::floor_remainder_numbers_f, 2);
...
TEST(Native_procedure, truncate_div_function ){
	...
	shaka::Number answer(-2);
	shaka::Number remainder(-1);
	shaka::Native_Procedure b(shaka::stdproc::truncate_div_numbers_f, 2);	
	auto result = b.call(a);
